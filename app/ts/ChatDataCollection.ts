...
let me: User = new User('Prayag', require('images/avatars/female-avatar-1.png'));
let ladycap: User = new User('Lamb of G_D', require('images/avatars/female-avatar-2.png'));
let echo: User = new User('Echo Musician', require('images/avatars/male-avatar-1.jpg'));
let rev: User = new User('Reverse Musician', require('images/avatars/female-avatar-4.png'));
let wait: User = new User('Waiting Musician', require('images/avatars/male-avatar-2.png'));
...
export class ChatDataCollection {
